...
"${PYTHON}" "${PROJECT_ROOT}/train_generation.py" \
  ...
  --run-name "llama3_2_1b_cnn_cores10_rank6_lowest_reconstruction" \
  ...
  --notes "phase=2.2.different_dataset_models_rank model=llama3.2-1b dataset=cnn variant=reconstruction total_cores=10 rank=6"
